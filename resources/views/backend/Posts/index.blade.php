                    ...
                    <table class="table  table-hover table-checkable dataTable no-footer dtr-inline" id="kt_table_1" role="grid" aria-describedby="kt_table_1_info" style="width: 992px;">
                        <thead>
                            <tr role="row">
                                ...
                                <th class="sorting" tabindex="0" aria-controls="kt_table_1" rowspan="1" colspan="1" style="width: 53.25px;" aria-label="Country: activate to sort column ascending">Short description</th>
                        ...
                        <tbody>
                            ...
                            <tr role="row" class="odd">
                                ...
                                <td><img src="{{asset('public/storage/' . $post->image )}}" height="40" width="50"></td>
                                <td nowrap="">
