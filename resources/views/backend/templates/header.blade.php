    ...
    <div class="kt-header__topbar-item kt-header__topbar-item--user">
        ...
        <!-- -->
            <div class="kt-header__topbar-user">
                ...
                <span class="kt-header__topbar-username kt-hidden-mobile"> salam </span>
        ...
        <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl" >
            ...
            <a  target="_blank" href="#" class="kt-notification__custom">
                    <div class="kt-notification__item-icon" style="margin-right: 10px;">
                ...
                <a  href="#" class="kt-notification__custom">
                    <div class="kt-notification__item-icon" style="margin-right: 10px;">
                ...
                <div class="kt-notification__custom">
                    <a href="#" target="" class="btn btn-label-brand btn-sm btn-bold">Sign Out</a>
                </div>
